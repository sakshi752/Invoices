...
const Header = () => {
    ...
    return (
        <div>
            ...
            <div id='invoice-header' className='z-50 hidden lg:block'>
                <div className='fixed top-0 left-0 w-[110px] z-50 h-screen dark:bg-[#1e2139] bg-[#373b53] flex flex-col justify-between duration-300 ease-in-out'>
                    <div>

            ...
            <div className='max-w-3xl mx-auto'>
                ...
                <div className='flex justify-between mt-6 items-center dark:bg-[#1e2139] bg-white shadow-lg px-7 py-5 rounded-md'>
                    ...
                    <div className='hidden md:flex items-center space-x-3 '>
                        <button className='text-[#7e88c3] text-center dark:bg-[#252945] hover:opacity-80  bg-slate-100 p-3 px-2 rounded '>Edit</button>
                        <button className='bg-red-500 text-white  p-3 px-2 rounded hover:opacity-80'>Delete</button>
                        <button className='bg-green-500 text-white  p-3 px-2 rounded hover:opacity-80'>Mark as paid</button>
                    </div>
                    {/* hide for large screen */}
                    <div className='flex items-center space-x-2 md:hidden'>
                        <button className='text-[#7e88c3] text-center dark:bg-[#252945] hover:opacity-80  bg-slate- text-xl rounded '><FaEdit/></button>
                        <button className='bg-red-500 text-white text-xl rounded hover:opacity-80'><MdDelete/></button>
                        <button className='bg-green-500 text-white text-xl rounded hover:opacity-80'><FcPaid/></button>
                    </div>
                </div>
